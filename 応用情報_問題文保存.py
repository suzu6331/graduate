...
GITHUB_TOKEN = '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'
        ...
        if isinstance(content, NavigableString):
            ...
            if content.name == 'div' and 'img_margin' in content.get('class', []):
                ...
                if img_tag and img_tag.get('src'):
                    ...
                    img_filename = f"{file_id}-{image_index}.gif"  # .gifに統一
                    # 保存およびGitHubアップロード
...
def main():
    ##################################################################
    base_url = 'https://www.ap-siken.com/kakomon/28_aki/q'  # 新しいベースURL
